...
helmNamespace='50214-cswx'

dockerUrl='docker.yunxuebao.com'
staticChartVersion='1.0.0'
# a APP名
# d dockerfile路径
# c chartPath路径
# v 发布版本key
...
dockerWork() {
  #build
  echo "sh:build -t ${dockerUrl}/${APP}:${imageVersion} -f ${dockerfile} /home/admin/${APP}"
  docker build -t ${dockerUrl}/${APP}:${imageVersion} -f ${dockerfile} /home/admin/${APP}
  # docker 推送
...
ossUpload() {
  echo "oos上传"
  mv -f /home/admin/${APP}/dist /tmp/${APP}
  mkdir -p /home/admin/${APP}/dist
  cp -f /tmp/${APP}/* /home/admin/${APP}/dist/
  chmod 755 /home/admin/${APP}/ADDP-INF/movefile.sh
  /home/admin/cswx-pc-daily/ADDP-INF/movefile.sh /tmp/${APP} /tmp/ossfs/cswx-pc
  rm -rf /tmp/${APP}
}
# ossUpload
autoVersion
